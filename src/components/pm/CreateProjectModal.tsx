                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-yellow-700">
                        <p>
                          There are no submitted applications available to convert. Either no
                          applications have been submitted yet, or all applications have already
                          been converted to projects.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={consumables}
                    onChange={(e) =>
                      setConsumables(e.target.value === '' ? '' : Number(e.target.value))
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    value={contingency}
                    onChange={(e) =>
                      setContingency(e.target.value === '' ? '' : Number(e.target.value))
                    }
                    className="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none"
                    min="0"
                    placeholder="0"
                ...
                <div>
                  ...
                  <input
                    ...
                    value={overhead}
                    onChange={(e) =>
                      setOverhead(e.target.value === '' ? '' : Number(e.target.value))
                    }
                    className="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none"
                    min="0"
                    placeholder="0"
