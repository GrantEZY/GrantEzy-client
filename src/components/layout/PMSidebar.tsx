...
export default function PMSidebar() {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      label: 'Profile',
      href: '/pm/profile',
      active: pathname?.startsWith('/pm/profile'),
    },
  ];
    ...
    <aside className="w-64 border-r border-[var(--color-gray-200)] bg-white shadow-sm">
      <div className="flex h-full flex-col">
        ...
        <div className="border-b border-[var(--color-gray-200)] p-6">
          <h2 className="text-lg font-semibold text-[var(--color-gray-900)]">Program Manager</h2>

          <p className="mt-1 text-sm text-[var(--color-gray-600)]">Cycle Management</p>
        </div>
