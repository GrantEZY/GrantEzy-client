  ...
  return (
    <div className="flex items-center space-x-3">
      <div className="text-right">
        <div className="text-gray-800 text-base font-semibold font-inter">
          Hello, {name}
        </div>
  ...
  return (
    <div className="relative">
      <input
        type="text"
        placeholder="Search"
        className="w-[400px] h-[55px] bg-[#F8F6FF] rounded-[30px] px-6 py-4 pr-12 
...
export default function Header() {
  return (
    <header className="h-[98px] bg-white border-b border-[#C8C8C8] px-6 py-4 w-full">
