          ...
          >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateArrayItem(field, index, "BudgetReason", e.target.value)
                }
      ...
      <div className="space-y-3 rounded-lg border border-gray-200 p-4">
        <div>
          ...
          <input
            ...
            value={item.BudgetReason}
            onChange={(e) =>
              updateSingleItem(field, "BudgetReason", e.target.value)
            }
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
        ...
        <div>
          ...
          <input
            ...
            value={item.Budget.amount}
            onChange={(e) =>
              updateSingleItem(field, "amount", Number(e.target.value))
            }
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            placeholder="0"
          />
