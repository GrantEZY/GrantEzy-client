...
export class GCVService {
   ...
   */
  async getAllGCVMembers(params: GetAllGCVMembersRequest): Promise<GetAllGCVMembersResponse> {
  ...
  async addGCVMember(data: AddGCVMemberRequest): Promise<AddGCVMemberResponse> {
    return httpClient.post<AddGCVMemberResponse>(API_CONFIG.ENDPOINTS.GCV.ADD_MEMBER, data);
  }

  /**
   * Update GCV user role (add or delete COMMITTEE_MEMBER role)
   */
  async updateGCVUserRole(data: UpdateGCVUserRoleRequest): Promise<UpdateGCVUserRoleResponse> {
  ...
  async createProgram(data: CreateProgramRequest): Promise<CreateProgramResponse> {
    return httpClient.post<CreateProgramResponse>(API_CONFIG.ENDPOINTS.GCV.CREATE_PROGRAM, data);
  }

  /**
   * Get all programs with pagination and filtering
   */
  async getPrograms(params: GetAllProgramsRequest): Promise<GetAllProgramsResponse> {
    const queryParams: Record<string, string> = {
      page: params.page.toString(),
      numberOfResults: params.numberOfResults.toString(),
    };
   ...
   */
  async updateProgram(data: UpdateProgramRequest): Promise<UpdateProgramResponse> {
    return httpClient.patch<UpdateProgramResponse>(API_CONFIG.ENDPOINTS.GCV.UPDATE_PROGRAM, data);
  }

  /**
   * Delete a program
   */
  async deleteProgram(data: DeleteProgramRequest): Promise<DeleteProgramResponse> {
    return httpClient.delete<DeleteProgramResponse>(API_CONFIG.ENDPOINTS.GCV.DELETE_PROGRAM, data);
  }
   ...
   */
  async addProgramManager(data: AddProgramManagerRequest): Promise<AddProgramManagerResponse> {
   ...
   */
  async getProgramCycles(params: GetGCVProgramCyclesRequest): Promise<GetGCVProgramCyclesResponse> {
    const queryParams: Record<string, string> = {
   ...
   */
  async getCycleDetails(params: GetGCVCycleDetailsRequest): Promise<GetGCVCycleDetailsResponse> {
    const queryParams: Record<string, string> = {
   ...
   */
  async updateProgramManager(data: AddProgramManagerRequest): Promise<AddProgramManagerResponse> {
