...
export default function CoApplicantDashboard() {
  ...
  if (selectedApplicationId) {
    return (
      <AuthGuard>
        <ApplicationDetailsView applicationId={selectedApplicationId} onBack={handleBackToList} />
      </AuthGuard>
    );
  }
      ...
      <CoApplicantLayout>
        <div className="min-h-screen bg-gray-50 p-6">
          <div className="max-w-6xl mx-auto">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Co-Applicant Dashboard</h1>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6">
                    You haven't been added to any applications yet. Once you accept an invitation,
