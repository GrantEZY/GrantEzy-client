            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  View project information as co-applicant
                </p>
              </div>
            </div>
            <span
                      ...
                      <div className="overflow-hidden rounded-md border border-gray-200">
                        <table className="min-w-full divide-y divide-gray-200">
                          ...
                          <tbody className="divide-y divide-gray-200 bg-white">
                            {project.allocatedBudget.ManPower.map(
                    ...
                    <div>
                      ...
                      <div className="overflow-hidden rounded-md border border-gray-200">
                        <table className="min-w-full divide-y divide-gray-200">
                          ...
                          <tbody className="divide-y divide-gray-200 bg-white">
                            {project.allocatedBudget.Equipment.map(
                              (item: any, index: number) => (
                                <tr key={index}>
                                  <td className="px-4 py-2 text-sm text-gray-900">
                                    {item.BudgetReason}
                    ...
                    <div>
                      ...
                      <div className="overflow-hidden rounded-md border border-gray-200">
                        <table className="min-w-full divide-y divide-gray-200">
                          ...
                          <tbody className="divide-y divide-gray-200 bg-white">
                            {project.allocatedBudget.OtherCosts.map(
                              (item: any, index: number) => (
                                <tr key={index}>
                                  <td className="px-4 py-2 text-sm text-gray-900">
                                    {item.BudgetReason}
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    {project.allocatedBudget.Consumables && (
                      <div className="rounded-lg border border-gray-200 p-4">
                        ...
                        <p className="mt-1 text-xl font-bold text-gray-900">
                          {formatCurrency(
                            (project.allocatedBudget.Consumables as any).Budget
                              ?.totalAmount,
                          )}
                        </p>
                      </div>
                    ...
                    {project.allocatedBudget.Travel && (
                      <div className="rounded-lg border border-gray-200 p-4">
                        ...
                        <p className="mt-1 text-xl font-bold text-gray-900">
                          {formatCurrency(
                            (project.allocatedBudget.Travel as any).Budget
                              ?.totalAmount,
                          )}
                        </p>
                      </div>
                    ...
                    {project.allocatedBudget.Contigency && (
                      <div className="rounded-lg border border-gray-200 p-4">
                        ...
                        <p className="mt-1 text-xl font-bold text-gray-900">
                          {formatCurrency(
                            (project.allocatedBudget.Contigency as any).Budget
                              ?.totalAmount,
                          )}
                        </p>
                      </div>
                    ...
                    {project.allocatedBudget.Overhead && (
                      <div className="rounded-lg border border-gray-200 p-4">
                        ...
                        <p className="mt-1 text-xl font-bold text-gray-900">
                          {formatCurrency(
                            (project.allocatedBudget.Overhead as any).Budget
                              ?.totalAmount,
                          )}
                        </p>
                      </div>
