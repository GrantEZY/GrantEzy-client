  ...
  useEffect(() => {
    const fetchCycles = async () => {
      try {
        ...
        console.log("Cycle statuses found:", allCycles.map(c => ({ id: c.id, status: c.status, slug: c.slug })));
      ...
      <AuthGuard>
        <ApplicantLayout>
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-600">Loading available funding cycles...</p>
          </div>
        </ApplicantLayout>
      </AuthGuard>
    );
      ...
      <ApplicantLayout>
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Available Funding Cycles</h1>
          ...
          {error && (
            <div className="rounded-lg border-2 border-red-200 bg-red-50 p-12 text-center">
              ...
              <h3 className="mt-2 text-sm font-medium text-red-900">Error Loading Cycles</h3>
          ...
          {filteredCycles.length === 0 && !error ? (
            <div className="rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">
                {searchTerm || statusFilter !== "all" ? "No cycles found" : "No Funding Cycles Available"}
              </h3>
                  ...
                  >
                    <div className="p-6">
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <span className={`ml-2 inline-flex rounded-full border px-2.5 py-0.5 text-xs font-medium ${getStatusColor(cycle.status)}`}>
                      ...
                      <p className="text-sm text-gray-600 mb-4 line-clamp-3">
                        {cycle.description || cycle.program?.description || "Apply for innovation funding to accelerate your startup journey."}
                      </p>
                      ...
                      <div className="space-y-3 mb-6">
                        ...
                        {cycle.budget && (
                          <div className="flex items-center text-sm text-gray-500">
                            ...
                            <span>
                              Funding: {cycle.budget.currency} {cycle.budget.amount.toLocaleString()}
                            </span>
                          </div>
                        )}
                        ...
                        {cycle.round && (
                          <div className="flex items-center text-sm text-gray-500">
                            ...
                            <span>Round: {cycle.round.year} - {cycle.round.type}</span>
                          </div>
                        )}
                      </div>
          ...
          {filteredCycles.length > 0 && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-blue-900">{filteredCycles.length}</div>
                ...
                <div>
                  ...
                  <div className="text-sm text-blue-700">Open for Applications</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-blue-900">
