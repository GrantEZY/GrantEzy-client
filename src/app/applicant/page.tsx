        ...
        <div className="mb-8">
          ...
          {isLoading ? (
            ...
            programs.length === 0 ? (
              <div className="rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  There are currently no grant programs available for
                  applications.
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {programs.map((program, index) => {
                  ...
                  const uniqueKey =
                    program.id || program.slug || `program-${index}`;
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <span className="ml-2 inline-flex rounded-full bg-green-100 px-2 py-1 text-xs font-semibold text-green-800">
                      ...
                      <div className="mt-4 flex items-center text-sm text-gray-500">
                        <span>
                          Organization: {program.organization?.name || "N/A"}
                        </span>
                      </div>
            ...
            <div className="rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">
                This program currently has no active cycles open for
                applications.
              </p>
              <p className="mt-1 text-xs text-gray-400">
                Note: The system currently shows only the active cycle per
                program.
              </p>
            </div>
          ) : (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-gray-900">
                          {cycle.title ||
                            `${selectedProgram?.details?.name} Cycle`}
                        </h3>
          ...
          {isLoadingApplications ? (
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {myApplications.map((application: any) => {
                ...
                const statusText = application.isSubmitted
                  ? "Submitted"
                  : "Draft";
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          {application.cycle?.program?.title ||
                            "Program information not available"}
                        </p>
                      </div>
                      <span
                        className={`ml-2 inline-flex rounded-full px-2 py-1 text-xs font-semibold ${statusColor}`}
                      >
                        {statusText}
                      </span>
                    </div>
                          ...
                          <button
                            onClick={async () => {
                              if (
                                ...
                                const success = await deleteUserApplication(
                                  application.id,
                                );
                                if (success) {
            ...
            <div className="rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">
                You haven't submitted any applications yet. Apply to an open
