              ...
              {filteredPrograms.map((program) => (
                ...
                >
                  ...
                  <div className="space-y-2 border-t border-gray-100 pt-4 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-500">TRL Range:</span>
                  ...
                  <div className="mt-4 border-t border-gray-100 pt-4">
                    {program.manager ? (
                      ...
                      <button
                        className="w-full rounded-lg border border-dashed border-gray-300 py-2 text-sm font-medium text-gray-600 hover:border-blue-500 hover:text-blue-600"
                        onClick={() => {
                          setSelectedProgram(program);
