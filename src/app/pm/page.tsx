    ...
    <AuthGuard>
      <PMLayout>
        <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-sm text-yellow-700">
                    You don't appear to be assigned to any program yet. Contact your administrator.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Program Cycles</h2>
              <p className="mt-1 text-gray-600">Manage application cycles for your program</p>
            </div>
          ...
          {cyclesError && (
            <div className="rounded-lg bg-red-50 p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-red-800">Error loading cycles</h3>
          ...
          {!isCyclesLoading && cycles.length === 0 ? (
            <div className="rounded-lg bg-white p-12 text-center shadow">
              ...
              <h3 className="mb-2 text-lg font-medium text-gray-900">No cycles yet</h3>
            ...
            <div className="rounded-lg bg-white shadow">
              <div className="border-b border-gray-200 px-6 py-4">
                <h2 className="text-lg font-semibold text-gray-900">Program Cycles</h2>
                ...
                <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
                  <div className="flex flex-1 justify-between sm:hidden">
                    ...
                    <button
                      ...
                      disabled={currentPage >= cyclesPagination.totalPages || isCyclesLoading}
                      onClick={() => loadCycles(currentPage + 1)}
                    >
                      Next
                    </button>
                    ...
                    <div>
                      <p className="text-sm text-gray-700">
                        ...
                        <span className="font-medium">
                          {(currentPage - 1) * (cyclesPagination.limit || 10) + 1}
                        </span>{' '}
                        to{' '}
                        <span className="font-medium">
                          {Math.min(
                        ...
                        of <span className="font-medium">{cyclesPagination.total}</span> results
                      </p>
                    </div>
                    <div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    As a Program Manager, you can create and manage program cycles. Each cycle
                    defines funding rounds, budgets, TRL criteria, and scoring schemes for
