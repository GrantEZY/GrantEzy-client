...
export default function PMProgramsPage() {
  ...
  const [assignedProgram, setAssignedProgram] = useState<
    (Program & { cycleCount: number }) | null
  >(null);
  ...
  useEffect(() => {
    if (cycles && cycles.length > 0) {
      ...
      if (firstCycle.program) {
        ...
        const cycleCount = cycles.filter(
          (c) => c.program?.id === program.id,
        ).length;
  ...
  const shouldShowProgram =
    assignedProgram &&
    (!searchTerm ||
      (assignedProgram.details?.name || "")
        .toLowerCase()
        .includes(searchTerm.toLowerCase()) ||
      (assignedProgram.details?.description || "")
        .toLowerCase()
        .includes(searchTerm.toLowerCase()));
          ...
          <div className="flex h-64 items-center justify-center">
            <div className="text-center">
              ...
              <p className="mt-4 text-gray-600">
                Loading your assigned programs...
              </p>
            </div>
          </div>
        </PMLayout>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Manage the innovation programs assigned to you as Program
                Manager
              </p>
            </div>
            <Link
          ...
          <div className="max-w-md">
            <div className="relative">
              ...
              <input
                className="block w-full rounded-md border border-gray-300 py-2 pr-3 pl-10 text-sm placeholder-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
          ...
          {!shouldShowProgram && !assignedProgram ? (
            <div className="rounded-lg bg-white p-12 text-center shadow">
              ...
              <p className="mb-4 text-gray-600">
                ...
                administrator to get assigned to innovation programs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div
                ...
                className="cursor-pointer rounded-lg bg-white p-6 shadow transition-all duration-200 hover:scale-[1.02] hover:shadow-lg"
                    ...
                    <div className="mb-2 flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span
                            className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${getStatusBadgeColor(assignedProgram.status)}`}
                          >
                            {assignedProgram.status === ProgramStatus.IN_ACTIVE
                              ? "INACTIVE"
                ...
                <div className="mt-4 grid grid-cols-2 gap-4">
                  <div className="rounded-lg bg-gray-50 p-3 text-center">
                    <div className="text-lg font-bold text-gray-900">
                      {assignedProgram.cycleCount}
                    </div>
                    <div className="text-xs text-gray-500">Active Cycles</div>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-3 text-center">
                    <div className="text-lg font-bold text-gray-900">
                      {assignedProgram.minTRL}-{assignedProgram.maxTRL}
                    </div>
                ...
                <div className="mt-4 space-y-2">
                  ...
                  {assignedProgram.organization && (
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium text-gray-900">
                        {assignedProgram.organization.name}
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    Select a program to manage its funding cycles. You will be
                    able to:
                  </p>
